...
class Query(BaseModel):
    ...
    json_plan_pg_real = models.JSONField(null=True)
    json_plan_hinter_real = models.JSONField(null=True)
    json_plan_pg = models.JSONField(null=True)
    json_plan_hinter = models.JSONField(null=True)
    converge = models.FloatField(null=True)
    prefix = models.CharField(max_length=250, null=True)
    join_order_pg = models.CharField(max_length=250, null=True)
    choosed_plan = models.CharField(max_length=100, null=True)
    join_order_hinter = models.CharField(max_length=250, null=True)
